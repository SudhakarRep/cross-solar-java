...
public class PanelController {
  ...
  public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
    ...
    List<DailyElectricity> listDailyPanelUsageData = dailyElectricityService.listDailyPanelUsageData(1); 
    if (listDailyPanelUsageData == null) {
    	 return ResponseEntity.notFound().build(); 
    } 
    return ResponseEntity.ok(listDailyPanelUsageData);
  }
}